import { GSplatResource, GSplatData, BoundingBox, Color, Script, Vec3, MiniStats } from 'playcanvas';
import { createSogs } from 'sogs';
// import { loadGsplatDataFromURL } from 'sogsdecoder'
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (!urlParams.has('ply')) {
        ...
        // const splatData = await loadGsplatDataFromURL('data4')
